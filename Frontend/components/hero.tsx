      ...
      <div className="relative z-10 mx-auto max-w-5xl px-6 text-center">
        ...
        >
          <span className="flex flex-col items-center sm:flex-row sm:items-end justify-center gap-1 sm:gap-4 md:gap-5">
            ...
            <span className="text-xl sm:text-3xl md:text-4xl lg:text-5xl text-warm-gray uppercase tracking-[0.15em] font-sans whitespace-nowrap">Detailing Co.</span>
          </span>
